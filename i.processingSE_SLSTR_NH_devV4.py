...
if __name__=="__main__":
    ...
    for an_output_name in sorted(anfiles):
        ...
        logfilename=base_name_out[:-1]+".info"
        ...
        #with open(F_ft_lock, "a+") as lockfile:
            ...
            if (os.path.exists(in_output_name)):
                ...
                if (os.path.exists(an_output_name)==True and os.path.exists(msce_output_name)==False):
                    ...
                    cmd =("i.opt.sceproc -g scamod -i %s -i %s -o %s,a --SCDA2_0 --coding cryoland --bt --scm %s,1 --ndsi %s,1 --trans2 %s,1 --scamod_bthr=283" % (an_output_name,in_output_name,msce_output_name,scmdir,ndsi,trandir))
                    print cmd
                    cmdexec(cmd)
            ...
            p.write("To: joanna.ossowska@enveo.at\n")
